...
export default function JourneyGraphic({ className = "" }: { className?: string }) {
  return (
        ...
        {STEPS.map((s, i) => (
          <Reveal key={s.step} delay={0.08 * i}>
            <div className="relative flex gap-4 sm:block">
              ...
              <div className="glass flex-1 rounded-3xl border border-line/70 p-5 text-left transition-all duration-300 hover:-translate-y-0.5 hover:shadow-glow-sm sm:p-6 sm:text-center">
